...
\chapter{Durchführung und Ergebnisse}\label{}
    ...
    \section{Ablauf der Studie}
        ...
        \section{Auswertung der Ergebnisse}
            ...
            berechnete ich eine neue Spalte für die Differenz. Die Daten habe ich dann als $.csv$ Datei exportiert, um die weitere Datenverarbeitung und statistische Auswertung in R durchzuführen. Dafür habe ich die R Version \textquote{stable 4.1.1} genutzt. Die statistische Auswertung dieser Daten, zunächst für die Schätzung der zurückgelegten Strecke, dann für das Präsenzgefühl werde ich in den folgenden Abschnitten vorstellen.

            Alle Antworten aus den Fragebögen und die in der Datenbank gespeicherten Mess-Daten sind im \textquote{\nameref{anhang}} abgebildet. Letztere wurden von mir der Übersicht wegen vom $.json$ Format in ein Tabellenformat umformatiert.
                ...
                \subsection{Schätzung der zurückgelegten Distanz}
                    ...
                    \begin{align}
                        \begin{split}
                            \mid D_g - D_m \mid \label{eq:dist} %TODO: formel,
                    %link 1033
                        \end{split}
                    \end{align}
                    ...
                    Eine Varianzanalye mit Messwiederholung setzt voraus, dass die einzelnen Stufen des \textquote{Within-Subject Factor}, in diesem Fall die Fortbewegungsart, normalverteilt sind. Diese sind in in Form eines Quantil-Quantil-Diagramms in \autoref{figure:diff_normality} abgebildet.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%presence
                \subsection{Präsenzgefühl}
                    Ob die Unterschiede der Ergebnisse des SUS-Präsenz-Questionaire signfikant sind wird im Folgenden ermittelt werden. Dabei werden die \textquote{SUS-Scores} der Durchläufe verglichen. Der SUS-Score ermittelt sich über die Anzahl der Fragen, die mit einem der Werte $6$ oder $7$, also den beiden Werten, die am meisten erlebte Präsenz beschreiben, beantwortet wurden.
                    ...
                    Da die Bedingungen einer Varianzanalyse für die Daten zur Präsenzerhebung nicht eingehalten werden können, wurde stattdessen ein Friedmann Test zur Feststellung signifikanter Unterschiede zwischen den Fortbewegungsarten zum $\alpha = 5\%$ Niveau durchgeführt, da dieser keine normalverteilte Daten voraussetzt.
                    %H0 erwähnen?
...
\chapter{Diskussion, Ausblick und Konklusion}\label{chapter:discussion-conclusion}
    ...
    \section{Diskussion und Ausblick}
        ...
        \subsection{Schätzung der zurückgelegten Distanz}
            ...
            Die in der hier vorgestellten Pilotierungsstudie erhobenen Daten konnten diese Hypothese leider nicht stützen, die Gegenhypothese konnte nicht verworfen werden. Die absolute Differenz zwischen geschätzter und gemessener zurückgelegter Distanz ist bei der Fortbewegungsart \textquote{Real-Walking} nicht geringer als bei den Alternativen. Es konnten keine signifikanten Unterschiede bei den Fortbewegungsbedingungen erfasst werden.
        ...
        \subsection{Präsenzgefühl in der virtuellen Umgebung}
            ...
            Beim Durchqueren der mit der hier vorgestellten Levelgenerierungmethode erstellten Level mit der \textquote{Real-Walking} Fortbewegungsart haben Nutzer:innen ein größeres Präsenzgefühl als mit den beiden Alternativen \textquote{Joystick} und \textquote{Teleportation}.

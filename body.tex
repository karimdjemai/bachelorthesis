...
\chapter{Konzipierung der Pilotierungsstudie}\label{chapter:experiment}
    ...
    \section{Hypothesen und Messvariablen}
        ...
        \begin{enumerate}
            ...
            , als die beiden alternativen \textquote{Joystick} und \textquote{Teleportaion}.
        ...
        \subsection{Raumverständnis}
            ...
            Mehrere Forschungsergebnisse deuten darauf hin, dass natürliches Gehen das Raumverständnis, im Vergleich zu anderen Fortbewegungsarten verbesset. \cite{langbehn-vergleich-2018,peck-vergleich-2011, walking-improves-map-building} %TODO: mehr?
...
\chapter{Durchführung und Ergebnisse}\label{}
    ...
    \section{Ablauf der Studie}
        ...
        Die Daten aus den Google-Forms Formularen und die gemessenen Daten aus der Firebase Datenbank wurden jeweils anonym hinterlegt. Die Datensätze lassen sich einander lediglich über eine Versuchspersonen-ID, die Bedingung, und die Raumlänge %TODO: klar was gemeint ist? umschreiben?
         zuordnen. Im folgenden werde ich die statistischen Verfahren vorstellen, mit denen ich die, im vorherigen Kapitel, aufgestellten Hypothesen überprüfen werde.
        ...
        \section{Auswertung der Ergebnisse}
            ...
            Mit der Formel %link?
            berechnete ich eine neue Spalte, für die Differenz. Das ganze
...
\begin{figure}[!h]
    ...
    \caption{caption caption}\label{figure:diff_plot}
\end{figure}
...
\begin{figure}[!h]
    ...
    \caption{caption caption}\label{figure:diff_normality}
\end{figure}
...
\begin{table}[]
    \renewcommand\arraystretch{1.2}
    \centering
    \caption{CaptionTODO: lets go shapiro diff}
    \begin{tabular}{lcc} \toprule
        Bedingung    & Teststatistik    & p   \\ \midrule
        Redirection  & 0.908            & 0.300 \\
...
\begin{table}[]
    \renewcommand\arraystretch{1.2}
    \centering
    \caption{CaptionTODO: lets go presence}
    \begin{tabular}{lccc} \toprule
        Bedingung       & n & M     & SD   \\ \midrule
        Redirection     & 9 & 2.33  & 1.80 \\
...
\begin{figure}[!h]
    ...
    \caption{caption caption presence plot}\label{figure:presence_plot}
\end{figure}
...
\begin{figure}[!h]
    ...
    \caption{caption caption presence norm}\label{figure:presence_normality}
\end{figure}
...
\begin{table}[]
    \renewcommand\arraystretch{1.2}
    \centering
    \caption{CaptionTODO: lets go shapiro presence}
    \begin{tabular}{lccc} \toprule
        Bedingung    & Teststatistik    & p   \\ \midrule
        Redirection  & 0.935            & 0.529 \\

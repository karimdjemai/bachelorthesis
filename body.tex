...
Die andere Variante der Levelgenerierung, hier \textquote{unmögliche} Variante genannt, umschließt immer nur den Raum in dem sich die Nutzer:in gerade befindet mit Wänden, und hat dementsprechend die Freiheit die gesamte Raumgröße zu umschließen, weil keine Kompromisse für den sich überlappenden Bereich $O$ gemacht werden müssen (siehe \autoref{figure:two_rooms}). Der Code für diese Generierung wird in der \textquote{RoomGenerator} -Klasse in den beiden \textquote{GenerateWalls}-Methoden ausgeführt. In dem Versuch wird diese Variante ausschließlich in der Real-Walking Bedingung eingesetzt. Durch sie werden die Räume erst zu Impossible Spaces, da die Räume sich nun überlappen.
...
\chapter{Experiment}\label{}
    \section{Versuchsaufbau}\label{}
    \section{Hypothesen}\label{}
    \section{Versuchsbedingungen}\label{}
        \subsection{Kontrollbedingung I Joystick}\label{}
        \subsection{Kontrollbedingung II Teleportation}\label{}
        \subsection{Versuchsbedingung Real-Walking}\label{}

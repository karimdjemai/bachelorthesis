...
Mit (Spiel-)Inhalten sind an dieser die meisten Elemente in Spielen gemeint. Unter anderem Texturen, Musik oder auch die Geschichte des Spiels können mit PCG erstellt werden. Im Rahmen dieser Arbeit hingegen beschäftige ich mich aber lediglich mit PCG zur Erstellung von Leveln.

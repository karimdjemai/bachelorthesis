...
%bedingung a (JS, TP)
\subsection{Realistische Wandgenerierung}
...
Mit dem Unity-Objekt $Random$ lässt sich durch Abrufen der Eigenschaft $value$ eine zufällige Zahl zwischen 0 und 1 generieren. %Footnote: falls 1 dann 0.99999
Um nun die Zahl aus der Liste verbleibender Richtungen $LD$ auszuwählen wird das Ergebnis nun mit $4 - length(LD)$ multipliziert um den Index zu berechnen.

...
Im folgenden Kapitel möchte ich das für diese Arbeit konzipierte Experiment vorstellen. Dabei handelt es sich um eine informelle Pilotierungsstudie.Zunächst werde ich die Umstände, die dieses umgeben haben erläutern, und danach die Ideen hinter dem Experiment erläutern. Zunächst werde ich den Aufbau, beschreiben, dann die verschiedenen Bedingungen vorstellen und erläutern und zuletzt die zu erforschenden Hypothesen aufstellen.
    ...
    \section{Versuchsaufbau}\label{sec:setup}
    Im Folgenden werde ich den Aufbau des Experiments beschreiben. Um einen gleichmäßig verteilten

    \section{Bedingungen}\label{}

...
Für die Tür-Vertices wird zunächst der untere Mittelpunkt der Tür berechnet.
...
Hierfür ist es zunächst wichtig die entsprechende Achse zu berechnen, auf der die Tür dann erzeugt wird (siehe Abbildung x) %TODO: figure
...
Dafür wird erstmal der Punkt, an der Frontalseite des Korridors, diagonal hinter $P$ berechnet um

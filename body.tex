...
\begin{multicols*}{2}
    Test testsidfjjl
    sdfkjwlkdjflskdjflksdhflsdhfös


    sdfjhskljdfhkjsdhfkjshdfkjshdf
...
\begin{tikzpicture}
    ...
    \umlclass[x=4,y=1]{GenerateLevel}{}{
    }
    ...
    \umldep[geometry=-|, anchors= 0 and -90, align2=left]{GenerateLevel}{RotationRedirector}

    \umldep[geometry=-|, anchors= 0 and 90, align2=left]{GenerateLevel}{RotationRedirectorCollision}

    \umldep[geometry=|-|, weight=0.7, anchors= 140 and -90, align2=left]{GeneratorOculusInterface}{OVRManager}
    ...
    \umluniassoc[geometry=|-|, anchors= -50 and 90]{RoomAndProgressManager}{RoomGenerator}

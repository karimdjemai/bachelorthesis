...
\chapter{Durchführung und Ergebnisse}\label{}
    ...
    \section{Ablauf der Studie}
        ...
        %marvs probleme?
        %TODO: 10 bei fortbewegung und 5 bei Präsenz

        \section{Statistische Evaluationsverfahren} %TODO: mit nächster section kombinieren
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%presence
                \subsection{Statistische Auswertung der Präsenz}
                    ...
                    durchgeführt. Dieser weist darauf hin, dass eine Normalverteilung bei Joystick ($p = 0,00316$) und Teleportation ($p = 0,00521$) nicht gegeben ist. Die Ergebnisse des Shapiro-Wilk Tests sind in \autoref{table:presence_shapiro} zu sehen.

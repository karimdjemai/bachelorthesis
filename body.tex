...
\begin{figure}[!h]
    ...
    \caption{Links: Eine sich gerade mit einem Auflösungseffekt öffnende Seitentür; Rechts: Die nun verschloßene Tür, die verhindert, dass die Nutzer:in nach der Ausführung des Rotationgains in den vorherigen Raum zurück geht}\label{figure:doors}
\end{figure}
            ...
            Alle Antworten aus den Fragebögen und die in der Datenbank gespeicherten Mess-Daten sind im \textquote{\nameref{anhang}} abgebildet. Letztere wurden von mir, der Übersicht wegen, vom $.json$ Format in ein Tabellenformat formatiert.
                ...
                \subsection{Statistische Auswertung zur Schätzung der fortbewegten Distanz}
                    ...
                    \begin{table}[!h]
                        ...
                        \end{tabular}
                        \caption{Arithmetische Mittel und Standartabweichungen der absoluten Differenz zwischen gemessener und geschätzer fortbewegter Distanz}\label{table:diff_means}
                    \end{table}
...
\end{tabular}
                        \caption{Arithmetische Mittel und Standartabweichungen des Verhältnisses zwischen gemessener und geschätzer fortbewegter Distanz, in allen möglichen Kombinationen; Die letzte Zelle einer Zeile oder Spalte zeigt das Arithmetische Mittel und die Standartabweichung für alle Daten zum jeweiligen Faktor}\label{table:ratio_means}
                    \end{table}

...
Im folgenden Kapitel möchte ich das für diese Arbeit konzipierte Experiment vorstellen. Dabei handelt es sich um eine informelle Pilotierungsstudie zur Vergleich von Fortbewegungsarten für das Raumverständnis und das Präsenzgefühl in der Virtuellen Umgebung. Untersucht werden soll dabei konkreter, ob die Fortbewegungsart \textquote{Real-Walking} in diesen Punkten bessere Effekte erzielt also vergleichbare alternative Fortbewegungsarten.
...
Im darauf folgenden Teil werde ich dann beschreiben wie der Statistische Versuchsplanung der konzipierten Pilotierungsstudie ist. Dabei werde ich genauer auf %TODO: ...
eingehen.

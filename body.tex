...
\begin{figure}[H]
    ...
    \caption{Zur Eckenberechnung genutzte Vektoren. Mit $C_{0}, C_1, C_2, C_3$ werden die Ecken bezeichnet, mit $S_{0}, ...,  S_3$ die Seiten des Raumes (Nicht die zur Eckenberechnung genutzen Vektoren). }
...
Damit wird der Richtungsvektor $rTL$ (rightToLeft) errechnet indem die rechte Ecke von der linken Ecke subtrahiert wird und das Ergebnis dann normalisiert wird.
...
Nach dem nun hoffentlich klar gewordenen Prinzip, die Knotenpunkte zu berechnen indem schon errechnete Knotenpunkte mit den entprechenden Richtungsvektoren multipliziert werden lassen sich nun die äußeren oberen, äußeren Ecken des Korridors bestimmen, hierfür werden die unteren Ecken mit dem Vektor $\vec{T}$ addiert, der sich wie folgt berechnet:
...
In der folgenden Erklärung wird davon ausgegangen, dass $D <= 0.5$ ist und somit die Haupttür links, und die Seitentür rechts erzeugt wird, andernfalls  wären natürlich $\hat{rTL}$ und $\hat{rTL} * (-1)$ vertauscht. %TODO: hier weitermachen(22.10)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %TODO: auf peck verweisen ===>
        ...
        %%%%%%%Anhang
        %Demographie Fragebogen
        Redirected Walking Study Karim Djemai (*: notwendig)
...
Hast du schonmal eine VR-Brille genutzt? *
ja, nein

Hast du eine Sehschwäche, wenn ja trägst du eine Brille/Kontaktlinsen *
single choice
    - Kaum/Keine Sehschwäche
    - Sehschwäche, aber Brille/Kontaktlinsen
    - Nicht-Korrigierte Sehschwäche

Hast du eine Gleichgewichtsstörung? *
ja, nein

Hast du sonstige Krankheiten oder gesundheitliche Probleme die deine Sicht beschränken? *
ja, nein
